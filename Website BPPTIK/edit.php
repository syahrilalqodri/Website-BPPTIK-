...
<html lang="en">
	...
	<body>
		...
		<div class="container" style="margin-top: 1%;">
            ...
            <table>
                ...
                <tr>
                    <td>Name</td>
                    <td> 
                    <input type="text" name="name" value="<?php echo $c['name'] ?>"> </td>
                </tr>
                <tr>
                    <td>Email</td>
                ...
                <tr>
                    <td>Address</td>
                    <td><input type="text" name="address" value="<?php echo $c['address'] ?>"></td>
                </tr>
                <tr>
                    <td>City</td>
                    <td><input type="text" name="city" value="<?php echo $c['city'] ?>"></td>
                </tr>
                <tr>
                    <td>Password</td>
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" name="register" value="Update">
        ...
        <a href="data_register.php" >Back</a>
        </div>
