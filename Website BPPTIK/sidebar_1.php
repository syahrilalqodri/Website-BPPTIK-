	...
	<div class="container" style="margin-top: 1%;">
		...
		<ul class="nav list-group">
			...
			<div class="col-md-6 bg-white rounded">
				<h4 style="color: #0E4C92; margin-top: 3%;">Visi Dan Misi LSP BPPTPIK</h4><hr>
				...
				<ul style="list-style-type:upper-alpha;">
					...
					<br>
						...
						<br>
					<li><b>Sasaran Mutu</b></li>
					<br>
					<p>LSP BPPTIK menetapkan sasaran mutu setiap tahun dengan melakukan pemantauan (monitoring) setiap semester.
						<br>
						<br>
					Sasaran mutu tersebut mencakup:</p>
				</ul>
				<ol>
					<li>jumlah pengguna layanan;</li>
					<li>tingkat kepuasan layanan;</li>
					<li>jumlah banding;</li>
					<li>jumlah keluhan; dan</li>
			...
			<div class="col-md-3">
					...
					<div class="p-4 bg-white rounded">
						<a href="pelatihan.php"><img src="images/skkni.jpeg" alt="" style="width: 100%">
					</div>
					<br>
