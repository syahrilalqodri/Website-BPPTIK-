...
<html lang="en">
	<head>
		<title>Ruang Lingkup LSP BPPTIK</title>
	...
	<div class="container" style="margin-top: 1%;">
		...
		<ul class="nav list-group">
			...
			<div class="col-md-6 bg-white rounded">
				<h4 style="color: #0E4C92; margin-top: 3%;">Ruang Lingkup LSP BPPTIK</h4><hr>
				<p>LSP BPPTIK merupakan LSP Pihak Kesatu (LSP-P1) yang utamanya melakukan sertifikasi kompetensi kepada peserta pelatihan BPPTIK dan/atau sumber daya manusia dari jejaring kerja Balitbang SDM Kementerian Kominfo, sesuai ruang lingkup yang diberikan oleh BNSP.
				<br></br>
				LSP BPPTIK melaksanakan layanan sertifikasi kompetensi sesuai anggaran LSP BPPTIK. Pelaksanaan sertifikasi kompetensi mengacu pada peraturan perundang-undangan yang berlaku. LSP BPPTIK tidak melaksanakan pendidikan dan pelatihan.</p>
